...
/* TODO: Write a new test suite named "The menu" */
    ...
    describe('The menu', function() {
        it('menu element is hidden by default ', function() {
            expect($('body').hasClass("menu-hidden")).toBe(true); //check if menu-hidden class is present or not
        });
        it('menu changes its visibility when clicked', function() {
            $(".menu-icon-link").click();
            expect($('body').hasClass("menu-hidden")).toBe(false); //Menu should open when icon is clicked
            $(".menu-icon-link").click();
            expect($('body').hasClass("menu-hidden")).toBe(true);
            //Menu should close if icon is clicked again
        });
    })
	...
	it('nextFeed is not equal to previousfeed', function() {
		...
		//verifying that old and new feed are not same
	});
